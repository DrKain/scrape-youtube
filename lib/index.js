...
var Youtube = /** @class */ (function () {
    ...
    Youtube.prototype.extractRenderData = function (page) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                ...
                var primary = youtubeData.contents.twoColumnSearchResultsRenderer.primaryContents;
     ...
     */
    Youtube.prototype.parseData = function (contents) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            try {
                var results_1 = {
                ...
                contents.forEach(function (item) {
                    ...
                    if (item['videoRenderer'] && item['videoRenderer']['lengthText']) {
                        try {
                            ...
                            var result = parser_1.getVideoData(videoRenderer);
                    ...
                    if (item['videoRenderer'] && !item['videoRenderer']['lengthText']) {
                        try {
                            var videoRenderer = item['videoRenderer'];
                            var result = parser_1.getStreamData(videoRenderer);
